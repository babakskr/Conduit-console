...
![Version](https://img.shields.io/badge/version-v0.2.11-blue?style=flat-square)
...
| :--- | :--- | :--- |
| `conduit-console.sh` | v0.2.11 | No description provided. |
| `conduit-optimizer.sh` | v1.8.2 | Adjusts CPU (Nice) and I/O priorities for Conduit instances to prevent lag. |

### 🔹 Utilities & Automation
| File | Ver | Description |
| :--- | :--- | :--- |
| `git_op.sh` | v1.8.1 | Automates version control, README generation, and GitHub releases. |
...
---
*Generated by Git Operations Manager v1.8.1 on Thu Jan 29 07:22:20 PM UTC 2026*
